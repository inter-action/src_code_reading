...
/*
used for create `FetchedDocument` from url
 */
public class HTTPTransport implements Transport {
    ...
    public void init() {
        ...
        //todo: allow_circular_redirects is for ?
        ...
        httpclient.getHttpConnectionManager().
            getParams().setMaxConnectionsPerHost(HostConfiguration.ANY_HOST_CONFIGURATION, 1);
    ...
    private FetchedDocument createDocument(String targetURL, GetMethod httpget) throws IOException, HTTPTransportException {
